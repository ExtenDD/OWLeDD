...
class DL_Tableau:
    ...
    def __init__(self,
        ...
        #2.6. deleting unnecessary objects
        ...
        #EXP only - save for reuse in the 'build_tableau' function
        self.use_SAT_optimisations = use_SAT_optimisations
#        self.rules_old = rules_old
    ...
    def build_tableau(self):
        ...
        #EXP ONLY - we need this to perform many runs of the same function
        self.interpretation = self.initial_interpretation
        ...
        if self.use_SAT_optimisations == True:
 ...
 #       rules_to_apply = [rules_old.clash_rule,
 #                             rules_old.double_neg_rule,
 #                             rules_old.conjunction_rule,
 #                             rules_old.role_rule_2,
 #                             rules_old.negated_conjunction_rule,    
 #                             rules_old.global_description_rule_1,
 #                             rules_old.global_description_rule_2,
 #                             rules_old.global_description_rule_3,
 #                             rules_old.global_description_cut_rule,
 #                             rules_old.local_description_rule_1,
 #                             rules_old.local_description_rule_2,
 #                             rules_old.local_description_rule_3,
 #                             rules_old.local_description_cut_rule,
 #                             rules_old.role_rule_1]           
